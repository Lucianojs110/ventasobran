                ...
                {{Form::token()}}
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$art->nombre}}" required name="nombre" class="form-control" placeholder="Nombre del artículo..." style="text-transform:uppercase;"  onkeyup="javascript:this.value=this.value.toUpperCase();">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="precio_venta" min="0"  step="any"value="{{$art->precio_venta}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea  name="descripcion"   class="form-control" placeholder="Descripción del artículo..." cols="20" rows="10">{{$art->descripcion}} </textarea>
                            </div>
                        </div>
