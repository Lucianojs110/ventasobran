            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <h3>Listado de Artículos
                        <button data-toggle="modal" data-target="#modal-agregar-articulo" class="btn btn-xs btn-success"><i data-toggle="tooltip" title="Agregar Artículo" class="fa fa-plus"></i>
                        </button>
                        <button class="btn btn-primary btn-xs" form="pdfcodigo" type="submit"><i data-toggle="tooltip" title="Imprimir Codígos" class="fa fa-fw fa-print"></i>
                        </button>
                        <button data-toggle="modal" data-target="#modal-act-precios" class="btn btn-xs btn-warning"><i data-toggle="tooltip" title="Actualizar Precios" class="fa fa-fw fa-money"></i>
                        </button>
                    </h3>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#agregar_form").keypress(function(e) {
            if (e.which == 13) {
                return false;
            }
        });
