<div class="modal modal-success fade in" id="modal-agregar-cliente">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <img src="{{asset('imagenes/loading.gif')}}"   height="50%" width="50%">
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text"  name="num_documento"  id="num_documento" class="form-control" placeholder="Número de documento...">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label for="nombre">Nombre</label>
                                <input type="text" required id="nombre" name="nombre" class="form-control" placeholder="Nombre...">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label for="nombre">Dirección</label>
                                <input type="text" required  id="direccion" name="direccion" class="form-control" placeholder="Dirección...">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <label>Tipo de Cliente</label>
                             <input type="text" class="form-control" value="Consumidor Final" readonly name="tipo" id="tipo" placeholder="escribe el tipo de cliente">
                            </div>
                        </div>
