                            ...
                            <div class="row">   
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                     <div class="form-group">
                                         ...
                                         <input type="text"  name="pcodigo" id="pcodigo"
                                                class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                             ...
                             <div class="row"> 
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.1" min="1" name="pcantidad" id="pcantidad"
                                                class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01" min="0.1" name="pprecio_venta" id="pprecio_venta"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01"  min="0.1" name="pdescuento" id="pdescuento"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group" id="pa1">
                                    ...
                                    <input type="number" form="cre" class="form-control" value="0" id="tarjeta_debito"
                                           placeholder="Tarjeta de Debito" step="0.01" min="0" name="tarjeta_debito">
                                </div>
                                <div class="form-group" id="pa2">
                                    ...
                                    <input type="number" form="cre" class="form-control" value="0" id="tarjeta_credito" 
                                           placeholder="Tarjeta de Credito" step="0.01" min="0" name="tarjeta_credito">
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group" id="pa1">
                                            <label for="tarjeta_debito">Porcentaje de Credito</label>
                                            <input type="number" form="cre" step="any" onchange="porcentaje()" onkeyup="porcentaje()"
                                                   class="form-control" value="0" min="0" id="porcentaje_credito"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group" id="pa1">
                                            ...
                                            <input type="number" form="cre" step="any" onchange="porcentajeDos()" onkeyup="porcentajeDos()"
                                                   class="form-control" value="0" min="0" id="monto_porcentaje"
                                ...
                                <div class="form-group" id="pa3">
                                    ...
                                    <input type="number" form="cre" class="form-control" value="0" id="paga"
                                           placeholder="Efectivo" min="0" step="0.01" name="paga">
                                </div>

                                <div class="form-group" id="pa3">
                                    
                                <label>Canal de venta</label>
                                    <select name="canal_venta" id="canal_venta" class="form-control">
...
<!-- inicio ticket -->
        ...
        <div>
        <div class="row" >
                <div id="table" style="display: none" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                        <table >
                        <thead>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function pagos() {
                ...
                var paga = $("#paga").val();
                var total_venta =  parseFloat($("#total_venta").val()).toFixed(2);
