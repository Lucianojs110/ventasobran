    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="chart">
                        <div style="height: 500px" id="donutchart"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="chart">
                        <div style="height: 500px" id="donutchart2"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            @foreach ($promedioventa as $promedioventas)
                ...
                @endphp
            @endforeach
            <h3 class="box-title">Recaudación de los ultimos 14 días</h3>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
    ...
    <script type="text/javascript">
        var line = new Morris.Line({
            ...
            data: [
                    @foreach ($promedioventa as $promedioventas)
                {
                    x: '{{$promedioventas->created_at}}', item1: {{$promedioventas->total_venta}}},
                @endforeach
            ],
            xkey: 'x',
            ykeys: ['item1'],
