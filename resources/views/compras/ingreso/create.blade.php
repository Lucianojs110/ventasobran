            ...
            <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <div class="form-group">
                                    <label for="">
                                        <hr></label>
                                    <button type="button" id="bt-add" class="btn btn-primary btn-xs"><i
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table">
                            <table id="detalles" class="table">
                                ...
                                <tfoot>
                                    ...
                                    <th></th>
                                    <th>
                                        <h4 id="total">$ 0.00</h4><input type="hidden" name="total_ingreso"
                                                                                 id="total_ingreso"></th>
                                    </th>
                                </tfoot>
                                <tbody>
                ...
                <div class="container-fluid" id="guardar">
                    <div class="form-group">
                        ...
                        <button id="cre" class="btn btn-primary pull-left btn-xs btn-flat" type="submit"><i
                                class="fa fa-save"></i> Guardar </button>
                        <button class="btn btn-danger pull-right btn-xs btn-flat" type="reset"><i
