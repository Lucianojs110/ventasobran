...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Recaudamiento: {{date("d-m-Y", strtotime($pre->fecha_hora))}}</title>
    <link  />
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="{{URL::to('/')}}/imagenes/letra/r.png">
      </div>
      <h1>Recaudación: {{date("d-m-Y", strtotime($pre->fecha_hora))}}</h1>
      {{-- <div id="project">
      ...
      {{-- <div id="project">
        ...
        <div><span>Direción</span> 796 Silver Harbour, TX 79273, US</div>
        <div><span>Correo Electronico</span> <a href="mailto:john@example.com">john@example.com</a></div>
      ...
      <table>
        ...
        <tbody style="border-top: 2px solid #337ab7;">
          ...
          <tr>
            ...
            <td style="border-top: 2px solid #337ab7;"></td>
            <td style="border-top: 2px solid #337ab7;"></td>
            <td  class="text-derecha" style="border-top: 2px solid #337ab7;">{{$pre->total_venta}}</td>
          </tr>
        </tbody>
      </table>
    </main>
